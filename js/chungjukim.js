window.onload = function () {
  ...
  //   idLog.innerText = "";
  //   idLog.style.color = "#c4c4c4";
  //   if(kimId.value !== ""){
  //     if(!idReg.test(kimId.value)){
  //         idLog.style.color = "red";
  //         idLog.innerText = "정확한 값을 입력해주세요.";
  //         idLog.appendChild(document.createElement("br"));
  //         kimId.focus();
  //     };
  //   };
  // });
  ...
  //   pwLog.innerText = "";
  //   pwLog.style.color = "#c4c4c4";
  //   if(kimPw.value !== ""){
  //     if(!passwordReg.test(kimPw.value)){
  //       pwLog.style.color = "red";
  //         pwLog.innerText = "정확한 값을 입력해주세요.";
  //         pwLog.appendChild(document.createElement("br"));
  //         kimPw.focus();
  //     };
  //   };
  // });
